...
public class CBallMaze extends JFrame implements ActionListener{
	...
	private static final File Filesound = null;
	private JPanel Panel1,Panel2,Panel3;
	private JButton bAct,bRun,bReset,bPause;
	...
	private ImageIcon bImage = new ImageIcon("PSP\\sand60x60.png"); // bImage is for the image of Ball
	...
	private void createGUI() {
		...
		ImageIcon bPauseImage = new ImageIcon("PSP\\pause.png");
		...
		bAct.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				timer.start();
				if(bX==0 && bY==12) {
					JOptionPane.showMessageDialog(null,"Congratulations!! you've win the game");
				}
			}
